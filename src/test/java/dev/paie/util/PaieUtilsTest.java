...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_entier_negatif_virgule() {
		String resultat = paieUtils.formaterBigDecimal(new BigDecimal("-2.186"));
		assertThat(resultat, equalTo("-2.19"));
	}
